...
max_daegu = max(daegu)
print("인천 최고값: %d" %max_incheon)
print("대구 최고값: %d" %max_daegu)

# 최저값
min_incheon = min(incheon)
min_daegu = min(daegu)
print("인천 최저값: %d" %min_incheon)
print("대구 최저값: %d" %min_daegu)

# 평균
mean_incheon = sum(incheon) / len(incheon)
mean_daegu = sum(daegu) / len(daegu)
print("인천 평균: %d" %mean_incheon)
print("대구 평균: %d" %mean_daegu)
...
print("인천 분산: %d" %var_incheon)
print("대구 분산: %d" %var_daegu)

# 표준편차
std_incheon = math.sqrt(var_incheon)
std_daegu = math.sqrt(var_daegu)
print("인천 표준편차: %d" %std_incheon)
print("대구 표준편차: %d" %std_daegu)